...
public class CuriosityServiceTests {
    ...
    public void shouldAddCuriosity() {
        ...
        CuriosityRequest curiosity2 = new CuriosityRequest("second title", "Test curiosity");
        Curiosity expectedCuriosity1 = new Curiosity(0L, "first title", "Some curiosity");
        CuriosityResponse expectedCuriosity2 = new CuriosityResponse(1L, "second title", "Test curiosity");
        ...
        CuriosityResponse givenCuriosity2 = curiosityService.addCuriosity(curiosity2);
    ...
    public void shouldGetCuriosityById() {
        ...
        CuriosityResponse expectedCuriosity = new CuriosityResponse(1L,"test title", "test curiosity");
        CuriosityResponse expectedCuriosity2 = new CuriosityResponse(10L,"test title2", "test curiosity2");
        curiosityData.addAll(List.of(curiosity,curiosity1,curiosity2));

        // WHEN
        CuriosityResponse givenCuriosity = curiosityService.getCuriosityById(1L);
        CuriosityResponse givenCuriosity2 = curiosityService.getCuriosityById(10L);
    ...
    public void shouldGetAllCuriosities() {
        ...
        List<CuriosityResponse> expectedCuriosities = curiosityData.stream()
                .map(ModelMapper::mapCuriosityToCuriosityResponse)
                .collect(Collectors.toList());

        // WHEN
        when(curiosityRepository.findAll()).thenReturn(curiosityData);
        List<CuriosityResponse> givenCuriosities = curiosityService.getAllCuriosities();
